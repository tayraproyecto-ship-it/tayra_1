...
if(hierba == "diente de leon"){

    titulo.innerHTML = "Diente de Leon";

    descripcion.innerHTML =
        " ) es una planta silvestre con reconocidas propiedades medicinales diuréticas y digestivas. En Huancayo, se comercializa habitualmente en mercados locales tradicionales y tiendas naturistas; además, se cultiva o crece de forma espontánea en zonas templadas y húmedas de la región Junín";

    imagen.src = "diente_de_leon.jpg";
}
